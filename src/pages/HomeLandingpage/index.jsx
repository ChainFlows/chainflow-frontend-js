      ...
      <div className="flex flex-col items-center justify-start w-full pr-[3px] gap-[250px] py-[3px] bg-gray-200 shadow-sm">
        <div className="flex flex-col items-center justify-start w-full mt-[73px] max-w-[1171px]">
          <div className="flex flex-col items-start justify-start w-full gap-10">
            <Text size="14xl" as="p" className="w-[14%] ml-2.5 !text-blue_gray-900_02">
              CHAIN FLOW
            </Text>
            <div className="flex flex-col items-center justify-start w-full">
              <div className="h-[405px] w-[99%] relative">
                <div className="flex flex-row justify-start items-center w-[59%] gap-px bottom-0 right-0 left-0 m-auto absolute">
                  ...
                  />
                  <Button color="blue_gray_900_02" size="19xl" className="min-w-[165px] rounded-[24px]">
                    Search
                  </Button>
                </div>
                <Img
                  src="images/img_image_705.png"
                  alt="image705_one"
                  className="h-[189px] w-[189px] left-0 top-0 m-auto rounded-[50%] absolute"
                />
                <Img
                  src="images/img_image_693.png"
                  alt="image693_one"
              ...
              <div className="flex flex-row justify-between items-start w-[99%] mt-[271px]">
                <Text size="9xl" as="p" className="mt-2.5 !text-blue_gray-900_02">
                  How it works
                </Text>
                <Img
                  src="images/img_image_699.png"
                  alt="image699_one"
              ...
              <div className="flex flex-row w-[99%] mt-[41px] gap-[66px]">
                  ...
                  <div className="flex flex-col items-end justify-start w-full gap-[11px]">
                    <div className="flex flex-row justify-start items-center w-[70%] mr-2 gap-[7px]">
                      <div className="flex flex-row justify-between items-center w-[69%] p-[5px] border-gray-500_03 border border-solid bg-gray-200 shadow-xs rounded-[10px]">
                        ...
                        <Img
                          src="images/img_image_704.png"
                          alt="delivery"
                          className="h-[9px] w-[9px] mr-1 rounded-[50%]"
                        />
                      </div>
                      <Button color="blue_gray_900_02" size="xs" className="!text-gray-400_02 min-w-[59px]">
                        Seach
                      </Button>
                    </div>
                    <div className="flex flex-col items-start justify-start w-full">
                      ...
                      />
                      <Text size="10xl" as="p" className="mt-6 !text-blue_gray-900_03">
                        Step
                      </Text>
                      <Text size="3xl" as="p" className="mt-[25px] ml-0.5 !text-blue_gray-800_08">
                        Enter your location. Type in your
                      </Text>
                      <Text size="3xl" as="p" className="w-[97%] mt-1.5 ml-0.5 !text-blue_gray-800_08 !leading-6">
                ...
                <div className="flex flex-col items-start justify-start w-[37%] gap-24 p-10 bg-gray-200 shadow-xs cursor-pointer rounded-[12px] hover:shadow-xs">
                  ...
                  <div className="flex flex-col items-start justify-start mb-[47px] ml-[11px] gap-[25px]">
                    ...
                    <Text size="3xl" as="p" className="!text-blue_gray-800_08 !leading-6">
                ...
                <div className="flex flex-col items-center justify-start w-[31%] mt-6 mb-[87px] gap-[18px] cursor-pointer hover:shadow-xs">
                  <Img
                    src="images/img_image_696.png"
                    alt="image696_one"
                    className="w-full object-cover rounded-[12px]"
                  />
                  <div className="flex flex-col items-start justify-start w-[82%]">
                    <Text size="8xl" as="p" className="ml-px !text-blue_gray-900_03">
                      Step 3
                    </Text>
                    <Text size="3xl" as="p" className="mt-[30px] ml-px !text-blue_gray-800_08">
                      Settle your payment. Then, sit
                    </Text>
                    <Text size="4xl" as="p" className="mt-1.5 !text-blue_gray-800_08 !leading-[26px]">
              ...
              <div className="flex flex-row justify-between items-center w-[99%] mt-[41px]">
                ...
                <Img src="images/img_image_703.png" alt="image703_one" className="w-[3%] object-cover rounded-[12px]" />
              </div>
                  ...
                  <div className="h-[301px] w-[68%] ml-[38px] relative">
                    <div className="flex flex-col items-center justify-start w-[65%] h-max gap-[37px] right-[6%] bottom-0 top-0 m-auto absolute">
                      <div className="flex flex-row justify-center w-full p-[5px] bg-gray-200 shadow-xs rounded-[12px]">
                        <Text size="6xl" as="p" className="mb-px !text-blue_gray-900_03 text-center">
                          RESTAURANT
                        </Text>
                      </div>
                      <div className="flex flex-row justify-start w-full p-[11px] bg-gray-400_03 shadow-xs rounded-[12px]">
                        <div className="flex flex-col items-start justify-start w-[63%] mt-[3px] mb-3">
                          <Text size="11xl" as="p" className="!text-blue_gray-900_02 z-[1]">
                            Proident
                          </Text>
                    ...
                    <Img
                      src="images/img_image_700.png"
                      alt="image700_one"
                      className="justify-center h-[301px] w-full left-0 bottom-0 right-0 top-0 m-auto object-cover absolute rounded-[12px]"
                    />
                  </div>
                  <Img
                    src="images/img_image_695.png"
                    alt="image695_one"
                    className="w-full object-cover rounded-[12px]"
                  />
                </div>
                <div className="flex flex-col items-start justify-start w-[27%]">
                  <Text size="10xl" as="p" className="ml-px !text-blue_gray-900_02">
                    As a Driver
                  </Text>
                  <Text size="3xl" as="p" className="w-[94%] mt-6 ml-px !text-blue_gray-800_08 !leading-6">
                  ...
                  <Button color="gray_200" size="17xl" className="mt-[22px] min-w-[193px] rounded-[24px]">
                    Drive with us
                  </Button>
                  <Text size="9xl" as="p" className="mt-[174px] ml-px !text-blue_gray-900_02">
                    As a Supplier
                  </Text>
                  <Text size="3xl" as="p" className="mt-6 ml-px !text-blue_gray-800_08">
                    ChainFlow helps Supplier
                  </Text>
                  <Text size="3xl" as="p" className="w-[88%] mt-[7px] ml-px !text-blue_gray-800_08 !leading-6">
                    grow with online ordering.
                    <br />
                    loyalty programs, and more.
                  </Text>
                  <Button color="gray_200" size="17xl" className="mt-10 min-w-[224px] rounded-[24px]">
                    Partner with us
                  </Button>
                  <Text size="9xl" as="p" className="mt-[169px] ml-px !text-blue_gray-900_02">
                    As a Client
                  </Text>
                  <Text size="3xl" as="p" className="mt-7 ml-px !text-blue_gray-800_08">
                    Be part of a team that&#39;s
                  </Text>
                  <Text size="4xl" as="p" className="mt-[13px] ml-px !text-blue_gray-800_08">
                    building a top-notch delivery
                  </Text>
                  <Text size="4xl" as="p" className="mt-3 ml-px !text-blue_gray-800_08">
                    service
                  </Text>
                  <Button color="gray_200" size="18xl" className="mt-[31px] min-w-[214px] rounded-[24px]">
                    Work with us
                  </Button>
                </div>
              </div>
              ...
              <div className="h-[382px] w-full mt-[53px] relative">
                <div className="flex flex-row justify-center items-center w-full h-full left-0 bottom-0 right-0 top-0 m-auto absolute">
                  <Button color="blue_gray_900_02" size="18xl" className="z-[1] min-w-[179px] rounded-[15px]">
                    Download
                  </Button>
                  <div className="flex flex-row justify-center items-start w-full ml-[-177px]">
                    <Text size="3xl" as="p" className="w-[46%] mt-[116px] !text-blue_gray-800_08 z-[1] !leading-6">
                      Get to experience the most convinite to fulfill you SupplyChain demands. Our fastest delivery
                      <br />
                ...
                <Text size="11xl" as="p" className="left-0 top-[15%] m-auto !text-blue_gray-900_02 absolute">
                  Order easily
                </Text>
              </div>
            </div>
          ...
          <div className="flex flex-row justify-center w-full mb-12 mx-auto max-w-[1190px]">
            <div className="flex flex-row justify-center w-full">
              <div className="flex flex-row justify-between items-center w-full gap-[461px]">
                <Text size="14xl" as="p" className="w-[13%] mt-px !text-blue_gray-900_02">
                  CHAIN FLOW
                </Text>
                <div className="flex flex-row justify-start items-start w-[49%] gap-[82px]">
                  <div className="flex flex-col items-start justify-start w-[59%] gap-3">
                    <div className="flex flex-row justify-between w-[77%]">
                      <Text size="3xl" as="p" className="mb-0.5 !text-blue_gray-900_03">
                        Social
                      </Text>
                      <Text size="3xl" as="p" className="!text-blue_gray-700_01">
                        Get help
                      </Text>
                    </div>
                    <div className="flex flex-row justify-between items-start w-full">
                      <div className="flex flex-col items-start justify-start gap-3">
                        <a href="facebook">
                          <Text size="2xl" as="p" className="!text-blue_gray-700_01">
                            Facebook
                          </Text>
                        </a>
                        ...
                        <ul className="flex flex-col items-center justify-start gap-[66px]">
                          <li>
                            <a href="Add your restaurant">
                              <Text size="2xl" as="p" className="!text-blue_gray-800_08">
                                Add your restaurant
                              </Text>
                            </a>
                          </li>
                  ...
                  <Text size="2xl" as="p" className="w-[28%] !text-blue_gray-700_01 !leading-[22px]">
                    Read our blog
                    <br />
                    Buy gift card
                    <br />
